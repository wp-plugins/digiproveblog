...
define("DPRV_HOST", "api.digiprove.com");                // you may use digibuild.docuprove.com for testing
define("DPRV_VERIFY_HOST", "verify.digiprove.com");      // you may use digibuild.docuprove.com for testing
define("DPRV_SSL", "No");
